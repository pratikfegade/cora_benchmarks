...
ko, ki = s[Am1].split(s[Am1].op.reduce_axis[0], factor = 4)
Am1_rf = s.rfactor(Am1, ki, 1)

ko, ki = s[Am1_rf].split(s[Am1_rf].op.reduce_axis[0], factor = nt)
Am1_rf_rf = s.rfactor(Am1_rf, ki, 1)

ko, ki = s[Am2].split(s[Am2].op.reduce_axis[0], factor = 4)
Am2_rf = s.rfactor(Am2, ki, 1)

ko, ki = s[Am2_rf].split(s[Am2_rf].op.reduce_axis[0], factor = nt)
...
s[Am1_rf_rf].vectorize(s[Am1_rf_rf].leaf_iter_vars[2])
