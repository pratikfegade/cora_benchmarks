...
luf = len_uf('s')
ls =  {
    0: Uf.from_constant('bd', args.batch_size),
...
if args.debug_code:
    ...
    l_input = run_utils.random_lengths(args.batch_size, MAX_LEN)
    run_utils.run(fadd, [l_input], i_bufs, [Q, K, O], args.batch_size, args.max_batches,
