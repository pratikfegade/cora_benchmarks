...
if args.target == "cuda":
    ...
    if args.sched == 1: O_o_o_i, O_o_i = s[O].split(O_o, factor=4)
    else: O_o_o_i, O_o_i = s[O].split(O_o, factor=2)
    ...
    if args.sched == 1: B_shared_ax0_o, B_shared_ax0_i = s[B_shared].split(B_shared_ax0, factor=2)
    else: B_shared_ax0_o, B_shared_ax0_i = s[B_shared].split(B_shared_ax0, factor=1)
